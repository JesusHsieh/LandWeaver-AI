                    ...
                    <div className="overflow-y-auto flex-1 p-2 space-y-2">
                        {scenes.map((scene, index) => (
                            <button
                                ...
                                className={`w-full p-2 rounded-lg border-2 transition-all text-left flex items-center gap-3 ${selectedSceneIndex === index ? 'border-emerald-600 bg-emerald-50 ring-1 ring-emerald-500 shadow-sm' : 'border-white bg-white hover:border-emerald-200 hover:bg-slate-50'}`}
                            >
                    ...
                    <div className="overflow-y-auto flex-1 p-4 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-3 py-2 border border-slate-300 rounded-md focus:ring-2 focus:ring-emerald-600 bg-slate-50 text-slate-900 text-sm resize-none"
                        ...
                        <div>
                            ...
                            {objectImage ? (
                                ...
                                <button 
                                    ...
                                    className="w-full px-3 py-3 border-2 border-dashed border-slate-300 bg-slate-50 text-slate-600 font-medium rounded-lg hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-300 transition-colors text-sm"
                                    disabled={currentScene?.isLoading}
                                >
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 p-1 bg-slate-100 rounded-lg">
                                <button
                                    onClick={() => setMode('day')}
                                    className={`px-3 py-2 rounded-md text-sm font-semibold transition-all flex-1 ${mode === 'day' ? 'bg-white text-emerald-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                                    disabled={currentScene?.isLoading}
                                >
                                ...
                                <button
                                    onClick={() => setMode('night')}
                                        className={`px-3 py-2 rounded-md text-sm font-semibold transition-all flex-1 ${mode === 'night' ? 'bg-white text-emerald-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                                        disabled={currentScene?.isLoading}
                                >
                            ...
                            <div className="flex justify-between mb-1">
                                ...
                                <span className="text-sm font-semibold text-emerald-600">{temperature}K</span>
                            </div>
                            <input
                                type="range"
                                min="2700"
                        ...
                        <div className="space-y-3 pt-2">
                            <button
                                ...
                                disabled={currentScene?.isLoading}
                                className="w-full px-4 py-3 bg-emerald-600 text-white font-bold rounded-lg hover:bg-emerald-700 transition-colors disabled:opacity-50 shadow-md"
                            >
