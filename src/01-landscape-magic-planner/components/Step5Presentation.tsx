...
const Step5Presentation: React.FC<Step5PresentationProps> = ({ finalPlanImage, generatedScenes, style, language }) => {
    ...
    const renderLoading = (messageKey: 'generatingPresentation' | 'generatingSlides') => (
        <div className="flex flex-col items-center justify-center h-64">
            <div className="loader border-4 border-emerald-200 border-t-emerald-600 rounded-full w-12 h-12 animate-spin mb-4" />
                        ...
                        <div>
                            ...
                            <div className="relative rounded-md shadow-sm">
                                <input
                                    ...
                                    className="block w-full px-4 py-2 text-base border-gray-300 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm rounded-md border bg-white"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {themes.map(theme => (
                            <button 
                                ...
                                className={`p-4 rounded-lg border-2 transition-all duration-200 ${selectedTheme.nameKey === theme.nameKey ? 'border-emerald-500 ring-2 ring-emerald-500' : 'border-slate-300 hover:border-emerald-400'}`}
                            >
            ...
            <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <div className="text-center flex flex-wrap justify-center gap-4">
                    <button 
                        ...
                        className="px-8 py-3 bg-emerald-600 text-white font-bold rounded-lg hover:bg-emerald-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
