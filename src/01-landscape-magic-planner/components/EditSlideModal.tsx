                    ...
                    {hasTitle && (
                         <div>
                            ...
                            <input
                                ...
                                className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm bg-white text-slate-900"
                            />
                        </div>
                    )}
                    ...
                    <div className="bg-emerald-50 p-3 rounded-md border border-emerald-100">
                        ...
                        <div className="flex flex-col gap-2">
                             <select
                                ...
                                className="block w-full px-3 py-2 text-sm border-gray-300 rounded-md focus:ring-emerald-500 focus:border-emerald-500 bg-white"
                            ...
                            <button
                                ...
                                className="w-full px-3 py-2 bg-emerald-600 text-white text-sm font-medium rounded-md hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 whitespace-nowrap"
                            >
