...
const ACTIVE_BTN = "bg-emerald-700 text-white shadow-md ring-2 ring-emerald-400";
...
const INPUT_STYLE = "border border-slate-300 rounded px-2 py-1 text-sm bg-white text-slate-900 font-medium focus:ring-2 focus:ring-emerald-600 focus:outline-none";
...
const App: React.FC = () => {
  ...
  const handleReset = (e?: React.MouseEvent) => {
      ...
      if (window.confirm("確定要清除所有圖形並重新開始？此操作無法復原。")) {
          // Clear Images
            ...
            <>
                ...
                <div className="flex flex-col gap-0.5 border-l pl-3 border-slate-200 ml-1">
                    ...
                    >
                        ...
                        <span className="font-medium">{showBackground ? '顯示背景' : '已隱藏'}</span>
                    </button>
                </div>
                 ...
                 <div className="flex flex-col gap-0.5 border-l pl-3 border-slate-200 ml-1">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button 
                            ...
                            title={arrowType === 'FILLED' ? "實心箭頭" : "空心箭頭"}
                        >
                        ...
                        <button 
                            ...
                            className={`p-1 rounded border transition-colors ${lineStyle === 'DASHED' ? 'bg-emerald-100 border-emerald-400 text-emerald-700' : 'bg-white border-slate-200 text-slate-400'}`}
                            title={lineStyle === 'SOLID' ? "實線" : "虛線"}
                        >
  ...
  return (
    <div className="flex flex-col h-screen w-full overflow-hidden text-slate-900 bg-slate-50 font-sans">
      <LandWeaverHeader projectName="景觀配置概念圖 AI" projectEmoji="🗺️" />
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-6">
              ...
              <div className="space-y-2">
                  ...
                  <div 
                    ...
                    className="w-full h-32 border-2 border-dashed border-slate-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-slate-50 hover:border-emerald-500 transition-colors relative overflow-hidden bg-white"
                  >
                      {refStyleImage ? (
                          ...
                          <>
                             ...
                             <span className="text-xs text-slate-500 font-medium">點擊上傳參考圖</span>
                          </>
                      )}
                  </div>
                  {refStyleImage && (
              ...
              <button
                  ...
                  className={`w-full py-3 rounded-lg font-bold text-white shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] ${isGenerating ? 'bg-slate-400 cursor-not-allowed' : 'bg-gradient-to-r from-emerald-700 to-emerald-800 hover:shadow-emerald-200'}`}
              >
                  {isGenerating ? (
