            ...
            <div className="flex justify-center gap-2">
                {[1, 2, 3, 4].map(num => (
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-semibold border-2 transition-colors ${numberOfImages === num ? 'bg-emerald-600 text-white border-emerald-600' : 'bg-white text-slate-700 border-slate-300 hover:border-emerald-400'}`}
                    >
        ...
        <div className="w-full max-w-6xl mx-auto">
                    ...
                    <div className="border-2 border-slate-200 rounded-lg p-2 bg-slate-50 min-h-[300px] relative">
                        {isGenerating && !isSelecting ? (
                            <div className="flex flex-col items-center justify-center h-full min-h-[300px]">
                                <div className="loader border-4 border-emerald-200 border-t-emerald-600 rounded-full w-12 h-12 animate-spin mb-3"></div>
                            ...
                            <div className="flex flex-col items-center justify-center h-full min-h-[300px] text-slate-400">
                                ...
                                <div className="flex justify-center mt-2">
                                    <button 
                                        ...
                                        className="px-6 py-3 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 transition-colors w-48 text-center"
                                    >
            ...
            {isSelecting && (
                <div className="mt-8 p-6 bg-emerald-50 border border-emerald-200 rounded-lg">
                    {selectedCandidate ? (
                        <div>
                            <h3 className="text-lg font-semibold text-emerald-800 mb-3 text-center">{getTranslation('selectionConfirmationTitle', language)}</h3>
                            <img src={selectedCandidate} alt="Selected candidate for confirmation" className="w-full max-w-lg mx-auto h-auto rounded-lg mb-4 border-4 border-emerald-500 shadow-lg" />
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-emerald-800 mb-3">{getTranslation('chooseRenderingTitle', language)}</h3>
                            <p className="text-emerald-700 mb-6">{getTranslation('chooseRenderingDescription', language)}</p>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {generatedOptions.map((url, index) => (
                                    <div key={index} className="relative group cursor-pointer" onClick={() => previewSelection(url)}>
                                        <img src={url} alt={`Generated option ${index + 1}`} className="w-full h-auto rounded-lg border-2 border-transparent group-hover:border-emerald-500 transition-all" />
            ...
            {showConfirmation && !isSelecting && (
                <div className="mt-8 p-6 bg-emerald-50 border border-emerald-200 rounded-lg">
                    <h3 className="text-lg font-semibold text-emerald-800 mb-3">{getTranslation('confirmRenderingTitle', language)}</h3>
                    <p className="text-emerald-700 mb-6">{getTranslation('confirmRenderingDescription', language)}</p>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 mb-4">
                            <input 
                                ...
                                className="flex-grow px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white text-slate-900" 
                        ...
                        <div className="p-4 bg-slate-100 rounded-lg border border-slate-200">
                             ...
                             <div className="flex justify-end mt-2">
                                <button 
                                    ...
                                    disabled={isGenerating || isSuggesting}
                                    className="px-6 py-2 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 transition-colors disabled:opacity-50 whitespace-nowrap"
                                >
