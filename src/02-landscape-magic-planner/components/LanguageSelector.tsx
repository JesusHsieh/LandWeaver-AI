            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full px-6 py-4 bg-emerald-700 text-white font-semibold rounded-lg hover:bg-emerald-800 transition-colors duration-200 flex items-center justify-center"
                    >
