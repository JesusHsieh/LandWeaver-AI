        ...
        <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-6">
                ...
                <div>
                    <label 
                        htmlFor="file-upload" 
                        className="cursor-pointer bg-emerald-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-emerald-700 transition-colors duration-200"
                    >
                ...
                {isAnalyzing && (
                    <div className="flex items-center gap-3 p-4 bg-emerald-50 rounded-lg">
                        <div className="loader border-4 border-emerald-200 border-t-emerald-600 rounded-full w-8 h-8 animate-spin" />
                        <span className="font-semibold text-emerald-700">{getTranslation('analyzingIndicator', language)}</span>
                    </div>
                )}
            </div>
        </div>
